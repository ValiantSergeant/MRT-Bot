...
const dbcreate = () => {
    db.serialize(() => {
        const queries = [
            ...
            `CREATE TABLE IF NOT EXISTS commands_status ( commandName TEXT, guildId TEXT, enabled INTEGER DEFAULT 1, PRIMARY KEY (commandName, guildId) )`,
            ...
            `CREATE TABLE IF NOT EXISTS wallet (discord_id TEXT, symbol TEXT, quantity INTEGER, buy_price REAL)`,      
            `CREATE TABLE IF NOT EXISTS sales (userId TEXT, date INTEGER)`,
